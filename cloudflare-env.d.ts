/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.typegen.jsonc --env-file=.env.example --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 6865e0cda5be4b9ee08c2809f966974f)
// Runtime types generated with workerd@1.20260801.1 2026-07-31 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	COMMUNITY_MEDIA: R2Bucket;
	COMMUNITY_DB: D1Database;
	COMMUNITY_RATE_LIMIT_STRICT: RateLimit;
	COMMUNITY_RATE_LIMIT_WRITE: RateLimit;
	COMMUNITY_RATE_LIMIT_INTERACTION: RateLimit;
	COMMUNITY_RATE_LIMIT_UPLOAD: RateLimit;
	ASSETS: Fetcher;
	...
	CALI_CENTRAL_ADMIN_EMAILS: string;
	CALI_CENTRAL_EDITOR_EMAILS: string;
	COMMUNITY_FEATURES_ENABLED: string;
	COMMUNITY_MEDIA_UPLOADS_ENABLED: string;
	TEAM_APPLICATIONS_ENABLED: string;
	ORGANIZATION_CLAIMS_ENABLED: string;
	VIDEO_SUBMISSIONS_ENABLED: string;
	MEDIA_SUBMISSIONS_ENABLED: string;
	SHOP_FEATURES_ENABLED: string;
	PRODUCT_SUBMISSIONS_ENABLED: string;
	PUBLIC_PROSPECTIVE_TEAMS_ENABLED: string;
	WCL_FEATURES_ENABLED: string;
	EXTERNAL_RANKINGS_ENABLED: string;
	WCL_ACTIVE_RULESET: string;
	NEXT_PUBLIC_SUPABASE_URL: string;
	NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY: string;
	SUPABASE_SERVICE_ROLE_KEY: string;
	AUTH_MIGRATION_PROVIDER: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SANITY_PROJECT_ID" | "NEXT_PUBLIC_SANITY_DATASET" | "NEXT_PUBLIC_SANITY_API_VERSION" | "NEXT_PUBLIC_SANITY_STUDIO_URL" | "SANITY_API_READ_TOKEN" | "SANITY_API_WRITE_TOKEN" | "NEXT_PUBLIC_SITE_URL" | "SITE_STAGE" | "SITE_INDEXING_ENABLED" | "SITE_CONTACT_EMAIL" | "AUTH_SECRET" | "AUTH_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "CALI_CENTRAL_ADMIN_EMAILS" | "CALI_CENTRAL_EDITOR_EMAILS" | "COMMUNITY_FEATURES_ENABLED" | "COMMUNITY_MEDIA_UPLOADS_ENABLED" | "TEAM_APPLICATIONS_ENABLED" | "ORGANIZATION_CLAIMS_ENABLED" | "VIDEO_SUBMISSIONS_ENABLED" | "MEDIA_SUBMISSIONS_ENABLED" | "SHOP_FEATURES_ENABLED" | "PRODUCT_SUBMISSIONS_ENABLED" | "PUBLIC_PROSPECTIVE_TEAMS_ENABLED" | "WCL_FEATURES_ENABLED" | "EXTERNAL_RANKINGS_ENABLED" | "WCL_ACTIVE_RULESET" | "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY" | "SUPABASE_SERVICE_ROLE_KEY" | "AUTH_MIGRATION_PROVIDER" | "R2_ACCOUNT_ID" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_BUCKET" | "UPSTASH_REDIS_REST_URL" | "UPSTASH_REDIS_REST_TOKEN">> {}
}
