/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.typegen.jsonc --env-file=.env.example --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 6356bf2700698b875549f691d3ede156)
