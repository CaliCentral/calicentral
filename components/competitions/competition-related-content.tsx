...
type CompetitionRelatedContentProps = {
...
export function CompetitionRelatedContent({
  athletes,
  stories,
  competitions,
  videos,
}: CompetitionRelatedContentProps) {
  if (
    athletes.length === 0 &&
    stories.length === 0 &&
  ...
  return (
    <section
      aria-labelledby="competition-related-heading"
        ...
        <div className="flex flex-col gap-5 border-t border-white/15 pt-5 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="font-mono text-xs font-bold uppercase tracking-[0.17em] text-accent">
              Connected field / Explicit relationships
            </p>
            <h2
              id="competition-related-heading"
