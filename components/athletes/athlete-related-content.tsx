...
type AthleteRelatedContentProps = {
...
export function AthleteRelatedContent({
  stories,
  athletes,
  competitions,
  videos,
}: AthleteRelatedContentProps) {
  if (
    stories.length === 0 &&
    athletes.length === 0 &&
  ...
  return (
    <section
      aria-labelledby="athlete-related-heading"
      ...
      <Container>
        ...
        {stories.length > 0 ? (
          <div className="mt-10">
            <p className="font-mono text-xs font-bold uppercase tracking-[0.15em] text-muted">
              From the editorial desk / Fictional stories
            </p>
        ...
        {competitions.length > 0 ? (
          <div className="mt-12 border-t border-white/12 pt-8">
            <p className="font-mono text-xs font-bold uppercase tracking-[0.15em] text-muted">
              Competition field / Fictional event records
            </p>
            <div className="mt-5 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
        ...
        {videos.length > 0 ? (
          <div className="mt-12 border-t border-white/12 pt-8">
            <p className="font-mono text-xs font-bold uppercase tracking-[0.15em] text-muted">
              Media archive / Related video records
            </p>
            <div className="mt-5 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
              {videos.map((video) => (
        ...
        {athletes.length > 0 ? (
          <div className="mt-12 border-t border-white/12 pt-8">
            <p className="font-mono text-xs font-bold uppercase tracking-[0.15em] text-muted">
              Other athlete files / Prototype profiles
            </p>
